...
\newcommand{\Ausweichen}{%
    ...
    \begin{dsaSheetBox}
        ...
        \begin{tabular}{p{1cm}p{0.3cm}p{0.7cm}p{0.3cm}p{2.5cm}p{0.3cm}p{1cm}}
            ...
            \textField[\ui{align={centered},textsize={14}}\Ff{\FfReadOnly}]{\FroEigAktuell{16}}{1cm}{18pt} &
            \normalsize $-$ &
...
\newcommand{\Trefferzonenbild}{
    ...
    \begin{tikzpicture}
        ...
        \node(bauch) at (3, 6) {\RS{\KamRusZonBauch}};
        \begin{scope}[on background layer]
        ...
        \node(rbein) at (1.9, 1.5) {\RS{\KamRusZonRechtesBein}};
        \begin{scope}[on background layer]
        ...
        \node(lbein) at (5.1, 1.3) {\RS{\KamRusZonLinkesBein}};
        \begin{scope}[on background layer]
