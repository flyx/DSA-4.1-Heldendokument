    ...
    \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
        \directlua{
            common.multiline_content({
                name="Nahkampf-SF", rows=data.sf.nahkampf.zeilen or 3,
...
\begin{minipage}{12.6cm}
	\begin{dsaSheetBox}[\textwidth]
        ...
        \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
            \directlua{
                local stile = {}
                for k,v in pairs(data.sf.kampfstil) do
                    table.insert(stile, "Kampfstil " .. k)
                end
                common.multiline_content({
                    name="Waffenlos-SF", rows=data.sf.waffenlos.zeilen or 3,
                    preamble="\noexpand\\footnotesize Sonderfertigkeiten",
                    baselinestretch=1.04, hspace="5pt", fontsize={8,12}
                }, stile, data.sf.waffenlos)
            }
        \end{tabular}
    \end{dsaSheetBox}
	\vspace{-28pt}
