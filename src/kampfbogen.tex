...
\begin{minipage}{12.6cm}
	\begin{dsaSheetBox}[\textwidth]
        ...
        \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
            \directlua{
                local stile = {}
                for k,v in pairs(data.SF.Waffenlos.Kampfstile) do
        ...
        \directlua{
            common.checkboxlist({
                ...
                {{"Schildkampf I (PA+2)", "II (PA+2)"},
                    data.SF.Nahkampf.Schildkampf},
                {{"Parierwaffen I", "II"}, data.SF.Nahkampf.Parierwaffen}
            })
        }
    \end{dsaSheetBox}
        ...
        \begin{dsaSheetBox}
            ...
            \CodeBefore\rowcolors{2}{white}{gray!30}\Body
                ...
                \multicolumn{2}{l|}{
                    ...
                    \directlua{
                        common.checkboxlist({
                            {{"I", "II", "III"}, data.SF.Nahkampf.Ruestungsgewoehnung}
                        })
                    }
        ...
        \begin{dsaSheetBox}
            ...
            \begin{tabular}{x{1cm}p{0.3cm}x{0.7cm}p{0.3cm}x{2.5cm}p{0.3cm}x{1cm}}
                ...
                \begin{minipage}{2.5cm}
                    \centering
                    \directlua{common.checkboxlist({{{"I", "II", "III"}, data.SF.Nahkampf.Ausweichen}})} \\
                    jeweils +3 \\
                    Flink (+1) / Behäbig (-1)?
                \end{minipage}
                & \normalsize $=$ &
