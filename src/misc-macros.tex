...
\newcommand{\Liturgien}{%
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        {\normalfont\normalsize%
        \begin{tabular}{p{3.7cm}@{(}x{3.7cm}@{):\hspace{1pt}}x{0.7cm}}
            \large\mansontt\bfseries Liturgiekenntnis & \directlua{tex.sprint(-2, data.Mirakel.Liturgiekenntnis.Name)} & \cellcolor{white}\directlua{tex.sprint(-2, data.Mirakel.Liturgiekenntnis.Wert)} \\
        \end{tabular}}
