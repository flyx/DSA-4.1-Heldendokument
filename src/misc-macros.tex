...
\newcommand{\Liturgien}{%
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        \directlua{
            common.kenntnis("Liturgiekenntnis", {data.Liturgiekenntnis}, 1)
        }
        ...
        \normalfont\fontsize{8}{12}\selectfont
        \begin{NiceTabular}{y{0.7cm}|p{7cm}|x{0.8cm}}
        \CodeBefore
            \rowcolors{2}{white}{gray!30}
        \Body
            \directlua{
            ...
            \directlua{
                common.inner_rows(data.Liturgien, 3, common.current_page.Liturgien())
            }
        \end{NiceTabular}
    \end{dsaSheetBox}
}
    ...
    \begin{dsaCharacterSheet}
        ...
        \begin{dsaSheetBox}
            ...
            \begin{tabular}{p{4cm}p{13.7cm}} \hline
                ...
                Merkmale: & \normalfont\directlua{
                    zauberliste.merkmalliste(data.Magie.Merkmalskenntnis)
                } \\ \hline
                Begabungen: & \normalfont\directlua{
                    zauberliste.merkmalliste(data.Magie.Begabungen.Merkmale, data.Magie.Begabungen.Zauber)
                } \\ \hline
                Unfähigkeiten: & \normalfont\directlua{
