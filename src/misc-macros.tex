\newcommand{\Kleidung}{
    ...
    \begin{dsaSheetBox}
        \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
            \directlua{
                common.labelled_rows(data.kleidung, "Kleidung", "Large")
            }
        \end{tabular}
    \end{dsaSheetBox}
}
...
\begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
    ...
    \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
        \directlua{
            common.labelled_rows(data.vermoegen.sonstiges, "Sonstiges")
        }
    \end{tabular}
\end{dsaSheetBox}
}
...
\newcommand{\Verbindungen}{
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
            \directlua{
                common.labelled_rows(data.verbindungen, "Verbindungen", "Large")
            }
        \end{tabular}
    \end{dsaSheetBox}
}
...
\newcommand{\Notizen}{
    \begin{dsaSheetBox}
        \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
            \directlua{
                common.labelled_rows(data.notizen, "Notizen", "Large")
            }
        \end{tabular}
    \end{dsaSheetBox}
}
    ...
    \begin{dsaCharacterSheet}
        ...
        \begin{dsaSheetBox}
            ...
            \begin{tabular}{p{4cm}p{13.7cm}} \hline
                ...
                Merkmale: & \normalfont\directlua{tex.sprint(-2, table.concat(data.magie.merkmale, ", "))} \\ \hline
                Begabungen: & \normalfont\directlua{tex.sprint(-2, table.concat(data.magie.begabungen, ", "))} \\ \hline
                Unfähigkeiten: & \normalfont\directlua{tex.sprint(-2, table.concat(data.magie.unfaehigkeiten, ", "))}
            \end{tabular}
        \end{dsaSheetBox}
