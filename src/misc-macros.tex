\newcommand{\Kleidung}{
    ...
    \begin{dsaSheetBox}
        \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
            \directlua{
                r.labelled_rows(v.kleidung, "Kleidung", "Large")
            }
        \end{tabular}
    \end{dsaSheetBox}
}
...
\begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
    ...
    \begin{tabular}{p{2.6cm}|x{0.7cm}|x{0.7cm}|x{0.7cm}|x{0.7cm}|x{0.7cm}|x{0.7cm}|x{0.7cm}|x{0.7cm}}
        ...
        \directlua{
            r.inner_rows(v.vermoegen, 9)
        } \\ \hline%
    \end{tabular}
    \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
        \directlua{
            r.labelled_rows(v.vermoegen.sonstiges, "Sonstiges")
        }
    \end{tabular}
\end{dsaSheetBox}
}
...
\newcommand{\Verbindungen}{
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
            \directlua{
                r.labelled_rows(v.verbindungen, "Verbindungen", "Large")
            }
        \end{tabular}
    \end{dsaSheetBox}
}
...
\newcommand{\Notizen}{
    \begin{dsaSheetBox}
        \begin{tabular}{p{\textwidth-1.33\tabcolsep}}
            \directlua{
                r.labelled_rows(v.notizen, "Notizen", "Large")
            }
        \end{tabular}
    \end{dsaSheetBox}
}
...
\newcommand{\Liturgien}{%
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        \directlua{
            r.kenntnis("Liturgiekenntnis", {v.liturgien.kenntnis})
        }
    ...
    \begin{dsaCharacterSheet}
        ...
        \begin{dsaSheetBox}
            \hspace{6pt}\directlua{
                r.eig_header({"MU", "KL", "IN", "CH", "FF", "GE", "KO", "KK"}, "16pt")
            }
            \renewcommand{\arraystretch}{1.25}
            \bfseries\large\mansontt
            \begin{tabular}{p{4cm}p{13.7cm}} \hline
                Repräsentationen: & \normalfont\directlua{r.reprs(v.magie.repraesentationen)} \\ \hline
                Merkmale: & \normalfont\directlua{tex.sprint(-2, table.concat(v.magie.merkmale, ", "))} \\ \hline
                Begabungen: & \normalfont\directlua{tex.sprint(-2, table.concat(v.magie.begabungen, ", "))} \\ \hline
                Unfähigkeiten: & \normalfont\directlua{tex.sprint(-2, table.concat(v.magie.unfaehigkeiten, ", "))}
            \end{tabular}
        \end{dsaSheetBox}
        ...
        \begin{dsaSheetBox}
            ...
            \Body
                \directlua{
                    r.header_row("scriptsize", "dsaSmallHeader",
