    ...
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        \begin{tabular}{p{\dimexpr\textwidth-2\tabcolsep}}
            \multirow[t]{7}{=}{\renewcommand{\baselinestretch}{1.35}\normalsize
                \directlua{
                    local fixed = {}
                    if data.vorteile.eisern then fixed:insert("Eisern") end
                    if data.vorteile.flink then fixed:insert("Flink") end
    ...
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        \begin{tabular}{p{\dimexpr\textwidth-2\tabcolsep}}
            \multirow[t]{7}{=}{\renewcommand{\baselinestretch}{1.35}\normalsize
                \directlua{
                    local fixed = {}
                    if data.nachteile.glasknochen then fixed:insert("Glasknochen") end
                    if data.nachteile.behaebig then fixed:insert("Behäbig") end
