...
\begin{dsaSheetBox}[\textwidth]
    \begin{tabular}{p{\dimexpr\textwidth-2\tabcolsep}}
        \directlua{common.multiline_content({
            name="Aussehen", rows=data.held.aussehen.zeilen or 3,
        ...
        \begin{tabular}{p{\dimexpr\textwidth-2\tabcolsep}}
            \directlua{
                ...
                common.multiline_content({
                    name="Vorteile", rows=data.vorteile.zeilen or 7, baselinestretch=1.35
    ...
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        \begin{tabular}{p{\dimexpr\textwidth-2\tabcolsep}}
            \directlua{
                ...
                common.multiline_content({
                    name="Nachteile", rows=data.nachteile.zeilen or 7,
