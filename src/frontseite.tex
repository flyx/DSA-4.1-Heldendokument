...
\begin{dsaSheetBox}[\textwidth]
    \begin{tabular}{p{\dimexpr\textwidth-2\tabcolsep}}
        \directlua{r.labelled_rows(v.held.aussehen, "Aussehen", "normalsize")}
    \end{tabular}
\end{dsaSheetBox}%
...
\begin{multicols}{2}
    ...
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        \begin{tabular}{p{\dimexpr\textwidth-2\tabcolsep}}
            \directlua{
                r.inner_rows(v.vorteile, 1, 7, "magisch")
            }
        \end{tabular}
    \end{dsaSheetBox}
...
\columnbreak
    ...
    \begin{dsaSheetBox}[.5\textwidth-.5\columnsep]
        \begin{tabular}{p{\dimexpr\textwidth-2\tabcolsep}}
            \directlua{
                r.inner_rows(v.nachteile, 1, 7, "magisch")
            }
        \end{tabular}
    \end{dsaSheetBox}
\end{multicols}
...
\begin{dsaSheetBox}[2\fboxsep + 6.72cm]
    ...
    \begin{tabular}{p{3.1cm}|x{1.2cm}|x{1.2cm}!{\vrule width 4\arrayrulewidth}x{1.2cm}}
        \directlua{
            r.header_row("tiny", "dsaSmallHeader",
...
\begin{dsaSheetBox}[2\fboxsep + 11.2cm]
    \setlength{\tabcolsep}{0pt}
    \renewcommand{\arraystretch}{1.325}
    \begin{tabular}{p{5.1cm}|x{1.2cm}|x{1.2cm}!{\vrule width 4\arrayrulewidth}x{1.2cm}!{\vrule width 4\arrayrulewidth}x{1.2cm}|x{1.2cm}}
        \directlua{
            r.header_row("tiny", "dsaSmallHeader",
                "", "Modifikator", "Start", "Aktuell", "Zugekauft", "Permanent")
            r.eig_rechts()
        }
    \end{tabular}
    \vspace{0.2pt}
...
\begin{dsaSheetBox}[\textwidth]
    \large
    \directlua{r.eig_header({"AP_Gesamt", "AP_Eingesetzt", "AP_Guthaben"}, "40pt", "2.5cm")}
\end{dsaSheetBox}%
